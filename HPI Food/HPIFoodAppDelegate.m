...
@implementation HPIFoodAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //This is our "MasterView", the event list
   HPIFoodMensaViewController * masterViewController = [[HPIFoodMensaViewController alloc] init];
